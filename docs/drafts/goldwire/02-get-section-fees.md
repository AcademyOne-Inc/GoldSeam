# Call 2 — Get section fees

[← Call 1 — Get section openings](01-get-section-openings.md) · [Summary](README.md) · Next: [Call 3 — Hold a seat →](03-hold-seat.md)
...
- **Before:** [Call 1](01-get-section-openings.md) showed section 002 has 2 seats: `sec_225070_2027SP_ENGL1301_002`.
- **This call:** "What does a seat in section 002 cost if I prepay, as an in-district student?"
- **After:** the learner accepts the price → [Call 3 — Hold a seat](03-hold-seat.md) with the `quote_id`.
...
| `section_id` (in the path) | `sec_225070_2027SP_ENGL1301_002` | yes | the section, from Call 1 | a `sec_` id |
...
| `quote_id` | `qt_01J8Z3V6N4` | **the price, fixed — send this to Call 3** |
...
| `due.now` | `241.00` | **what GoldCard must authorize in Call 5** |
...
| `refund_policy.source` | `pol_225070_refunds_2026_27` | the policy — the learner must acknowledge it in Call 6 |
...
| 400 | `VALIDATION_FAILED` | `section_id must look like sec_…; got '002'. Use an id from get_section_openings.` | the section number sent instead of the id | use the `section_id` from Call 1 |
...
| 404 | `SECTION_NOT_FOUND` | `No section sec_225070_2027SP_ENGL1301_009 is held. List sections with get_section_openings.` | wrong id | run Call 1 again |
...
`goldwire/225070/2027SP/sec_225070_2027SP_ENGL1301_002/quotes/qt_01J8Z3V6N4.json`
